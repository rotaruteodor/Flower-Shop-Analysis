...
flowershop_1_all_flowers = set([flower for list in list(flowershop_1_df[PRODUCT_CONTENTS_HEADER]) for flower in list])
flowershop_2_all_flowers = set([flower for list in list(flowershop_2_df[PRODUCT_CONTENTS_HEADER]) for flower in list])
flowershop_3_all_flowers = set([flower for list in list(flowershop_3_df[PRODUCT_CONTENTS_HEADER]) for flower in list])
